            ...
            <div className="Movie-detail-contend">
                <div className="Movie-poster">
                    <FontAwesomeIcon
                     ...
                     className="Heart-Icon" icon={faHeart} />
                    <img src={`${ImageOption.w500}${DetailMovie.poster_path}`} />
                </div>
                    ...
                    <ul className="Movie-geners-list">
                        {
                            DetailMovie.genres.map(function(item,idx){
                                return <li key={idx} className="Movie-geners-item primary-btn">{item.name}</li>
                            })
                        }
                    </ul>
                </div> 
